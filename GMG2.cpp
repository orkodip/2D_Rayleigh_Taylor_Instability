...
GMG2::GMG2()
{
	...
	NNZ=9*(I/2-2)*(J/2-2)+12*2*(J/2-2)+12*(I/2-2)+16;	//GCA 9 point stencil
	N/=4;
	C1=new int[NNZ];
	A1=new double[NNZ];
	R1=new int[N+1];
	...
	NNZ=9*(I/4-2)*(J/4-2)+12*2*(J/4-2)+12*(I/4-2)+16;	//GCA 9 point stencil
	N/=4;
	C2=new int[NNZ];
	A2=new double[NNZ];
	R2=new int[N+1];
	...
	NNZ=9*(I/8-2)*(J/8-2)+12*2*(J/8-2)+12*(I/8-2)+16;	//GCA 9 point stencil
	N/=4;
	C3=new int[NNZ];
	A3=new double[NNZ];
	R3=new int[N+1];
	...
	NNZ=9*(I/16-2)*(J/16-2)+12*2*(J/16-2)+12*(I/16-2)+16;	//GCA 9 point stencil
	N/=4;
	C4=new int[NNZ];
	A4=new double[NNZ];
	R4=new int[N+1];
